...
import FaceWork
import faces.facematrix_pb2 as facematrix_pb2
import faces.facematrix_pb2_grpc as facematrix_pb2_grpc
...
class FaceTransformServicerImpl(facematrix_pb2_grpc.FaceTransformServicer):
    ...
    def getMatrix(self, request, context):
        with open('image/hxx.jpg', 'wb') as f:
            f.write(request.face)
            f.close()
        transform = FaceWork.transform("image/hxx.jpg")
